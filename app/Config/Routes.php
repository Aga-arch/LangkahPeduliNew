...
$routes->group('dashboard', function ($routes) {
    ...
    $routes->group('pengajar', function ($routes) {
        ...
        $routes->get('materi/detail/(:num)', 'Materi::semua/$1');
...
$routes->group('penerima', function($routes){
    ...
    $routes->get('dashboard/penerima/mapel', 'PenerimaMapel::index');
    $routes->get('dashboard/penerima/mapel/(:num)', 'PenerimaMapel::detail/$1');

    // PENGHARGAAN PENERIMA
    $routes->get('penghargaan', 'Penghargaan::index');
    $routes->get('penghargaan/dapatkan/(:num)', 'Penghargaan::dapatkan/$1');

    // FORUM (khusus penerima)
    $routes->get('forum/join/(:num)', 'Forum::joinForum/$1');
    $routes->post('forum/komentar/(:num)', 'Forum::tambahKomentar/$1');

    $routes->get('materi/(:num)', 'PenerimaMateri::detail/$1');
    ...
    $routes->group('quiz', function ($routes) {
        ...
        $routes->get('/quiz/search', 'Quiz::search');
    });
